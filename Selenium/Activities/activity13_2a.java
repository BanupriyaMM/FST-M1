...
public class activity13_2a {
    public void writeExcel(String filePath) throws IOException {
        ...
        String[] row1 = {"1", "user1", "test1", "usertest1@example.com", "9874567876"};
        String[] row2 = {"2", "user2", "test2", "usertest2@example.com", "8978634565"};
        String[] row3 = {"3", "user3", "test2", "usertest3@example.com", "7545645679"};
